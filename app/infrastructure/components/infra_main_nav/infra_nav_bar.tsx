    ...
    return (
        <nav className="relative container">
            <div className="flex items-center justify-between gap-(--space-5)">
                ...
                >
                    <Image
                        src= "https://ik.imagekit.io/pleddsolca/korverna%20infrastructure/branding/logo_gold_white_text.png"
                         alt="korverna_logo"
                        width={200}
                        height={50}
                ...
                <div className="hidden md:flex items-center gap-(--space-2)">
                    {mainNavMenu.map((menu, idx) => (
                        <Button
                            ...
                            <span className={menu.special ? "font-bold text-foreground" : "font-bold text-background"}>
